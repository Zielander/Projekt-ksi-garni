...
<div id="app_top" class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href="">{$page_title|default:"Default page title"}</a>
        <ul>
            <li class="pure-menu-selected"><a href="#app_top">Do góry strony</a></li>
            {if count($conf->roles)>0}
            <li class="pure-menu-selected"><a class="button-logowanie pure-button" href="{$conf->action_root}Logout">Wyloguj się</a></li>
            <li></li>
            {else}
            <li class="pure-menu-selected"><a class="button-logowanie pure-button" href="{$conf->action_root}Login">Zaloguj się</a></li>
            <li></li>
            {/if}
            <li class="pure-menu-selected"><a class="button-rejestracja pure-button" href="{$conf->action_root}Register">Zarejestruj się</a></li>
            <li></li>
...
<div class="splash-container">
    <div class="splash">
        <h1 class="splash-head">{$page_title|default:"Default page title"}</h1>
